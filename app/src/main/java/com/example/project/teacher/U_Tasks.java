...
public class U_Tasks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseRef = database.getReference("uploaded_tasks");
    ...
    private void uploadFile(Uri fileUri, String fileName) {
        ...
        uploadTask.addOnSuccessListener(taskSnapshot -> {
            ...
            fileRef.getDownloadUrl().addOnSuccessListener(uri -> {
                ...
                Toast.makeText(U_Tasks.this, "File uploaded successfully", Toast.LENGTH_SHORT).show();
            });
        });
