...
public class UserGrades extends AppCompatActivity {
    ...
    private final BroadcastReceiver onDownloadComplete = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (id == downloadID) {
                ...
                Toast.makeText(UserGrades.this, "Download completed successfully", Toast.LENGTH_SHORT).show();
    ...
    private void retrieveLectures() {
        databaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(UserGrades.this, "Failed to retrieve lectures", Toast.LENGTH_SHORT).show();
            }
        });
    }
